<template>
  <div class="details">
    <!-- <div v-if="!meetlist.length" style="text-align: center; padding-top: 10%">
    ...
    <div v-for="item in meetlist" :key="item.id">
      <div v-if="item.id == meetId">
        ...
        <!-- 会议邀请弹窗 -->
        <!-- <el-dialog v-if="invitationdata" title="会议邀请" :visible.sync="invitation" :close-on-click-modal="false"
          :close-on-press-escape="false" :show-close="true" :modal="false" top="30vh" width="50%" center>
          ...
          <div style="width: 100%; text-align: center; margin-top: 5vh">
            <el-button type="primary" style="background:#00ccff;border:0;" round data-clipboard-action="copy"
              class="cobyDomObj" :data-clipboard-text="
            '会议主题：' +
            invitationdata.meetTopic +
            '\r\n会议链接：' +
            invitationdata.joinMeetUrl +
